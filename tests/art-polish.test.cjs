...
test('presentation uses formal assets with quiet fallbacks and no remote dependency',()=>{
  ...
  assert.match(menu,/class MenuArt/);assert.match(menu,/function drawV2Flyer/);assert.match(menu,/function drawV3Flyer/);assert.match(menu,/function fallback/);assert.match(menu,/function usable/);
