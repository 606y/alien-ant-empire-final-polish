...
test('V7 loading, world visuals, V6.3 opening and core implementation remain intact',()=>{
 const html=read('index.html');assert.ok(html.includes('app-ready.js?v=v7'));assert.ok(html.includes('world.js?v=v7'));assert.ok(html.includes('intro_cinematic_v6_3_capcut_badged.mp4'));
 ...
 assert.equal(hash('world.js'),'2c1ccfb2bb243974816b2cf4d3e60ec919d7ccadc41ccd8fe05073be49af053c');
