...
(() => {
  ...
  window.AntAppPresentation={menuArt,world};
  const formalAssets=window.AntAssets;formalAssets?.ready.then(()=>{const logo=$('menuLogo'),copy=document.querySelector('.menu-copy');if(formalAssets.mountImage('logoMain',logo))copy.classList.add('has-formal-logo');});
